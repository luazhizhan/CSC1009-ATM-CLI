...
public class CustomerDataSource extends DataSource<Customer>
{
    ...
    {
        super();
        setData(readDataFromCSV(CUSTOMER_CSV_PATH));
    }

    @Override
    protected List<Customer> readDataFromCSV(String filePath) throws FileNotFoundException, IOException
    {
        ...
        {
            data = dataList.get(i);
            Customer customer = new Customer(data[0],data[1],data[2],data[3],new Address(data[4],data[5],data[6],data[7],data[8],data[9],data[10]));
